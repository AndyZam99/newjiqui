import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-GT3OFGE3.js";
import "./chunk-4BXX3AGC.js";
import {
  Button,
  NEVER,
  PaneRouterContext,
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-RISHTFYN.js")),
  document: (0, import_react.lazy)(() => import("./pane-MQ5J6ONF.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-MQ5J6ONF.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-SDKXS7MS.js"))
};
...
//# sourceMappingURL=index3-XS4G25PR.js.map
